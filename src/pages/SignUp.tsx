...
export default function SignUp() {
  ...
  const isPasswordValid = formData.password.length >= 8 && formData.password.length <= 12;
            ...
            <form onSubmit={handleSubmit}>
              <div className="mb-4">
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-sm focus:outline-none focus:ring-2 focus:ring-blue-200 focus:border-blue-500"
                />
              </div>
              ...
              <div className="mb-6">
                ...
                <input
                  ...
                  onChange={handleChange}
                  placeholder="Must Have 8-12 Characters"
                  className="w-full px-3 py-2 border border-gray-300 rounded-sm focus:outline-none focus:ring-2 focus:ring-blue-200 focus:border-blue-500"
                />
                {!isPasswordValid && (
                  <p className="text-sm text-red-500">Password must be between 8 and 12 characters</p>
                )}
              </div>
              ...
              <button
                ...
                disabled={!isPasswordValid && !formData}>
                Sign Up
              </button>
            </form>
